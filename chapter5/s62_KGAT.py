...
class KGAT( nn.Module ):
    ...
    def __init__( self, n_users, n_entitys, n_relations, e_dim, r_dim,
        ...
        self.relation_embedding = nn.Embedding( n_relations, r_dim, max_norm = 1 )
    ...
    def GATMessagePass( self, h_embs, r_embs, t_embs ):
        '''
        :param h_embs: [ batch_size, n_neibours, e_dim ]
        :param r_embs: [ batch_size, n_neibours, r_dim ]
        :param t_embs: [ batch_size, n_neibours, e_dim ]
        '''
